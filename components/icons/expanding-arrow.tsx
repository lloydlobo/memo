 ...
 * ExpandingArrow.
 *
 * @param className - The class name to apply to the SVG elements.
 * @returns A React component that renders two SVG elements that animate
 *          between an arrow pointing to the right and an arrow pointing
 *          down.
