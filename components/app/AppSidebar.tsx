    ...
    return (
        <>
            <div className={`${className}`}>
                {/* <button onClick={() => setToggleDrawer(!toggleDrawer)} className="btn-ghost btn absolute top-2 left-1 z-50 backdrop-blur-sm " > <HamburgerIcon className="h-auto w-5" /> </button> */}
                ...
                <div className="sticky top-16 -mb-16 w-full">
                    <ul className="menu menu-compact relative w-auto overflow-y-auto pt-5 text-base-content">
